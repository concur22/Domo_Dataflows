-- Left join Job Stages to Applications, get Job Stage Name from Job Stages
...
-- Left join Job Openings w/ Entity to Job Openings to get Entity field
job_openings_join_1 AS (
    ...
    LEFT JOIN "job_openings_w_entity" jo_we
        ON jo.id = jo_we.id
),

-- Left join job_openings_join_1 to applications_join_1
...
-- Left join Jobs to applications_join_2
...
-- select columns from Offers and rank and window by application_id
offers_select1 AS (
    SELECT *
    FROM (
        SELECT
...
-- Left join offers to applications_join_3
...
-- Left join Job Recruiters to applications_join_3
...
-- Final Select statement; rank and window by "Job Openings ID"
